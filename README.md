...
- **The early style fine-tune made the model weaker, not stronger.** Fine-tuning straight onto the Phase 1 checkpoint dropped strength from ~1330 to ~1270, since my own move preferences aren't always the objectively strongest move. This is why style fine-tuning was pushed to Phase 3, after RL.
